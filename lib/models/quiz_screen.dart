...
class _QuizScreenState extends State<QuizScreen> {
  ...
  int answeredCount = 0;
  Set<int> answeredFlashcards = Set(); // Set to track answered flashcards by their IDs
              ...
              GestureDetector(
                onTap: () {
                  setState(() {
                    ...
                    // Only increment answeredCount if this flashcard hasn't been answered before
                  if (showAnswer && answeredFlashcards.add(flashcard.id!)) {
                      answeredCount++;
                    }
                  });
                },
                ...
                GestureDetector(
                  onTap: () {
                    setState(() {
                      ...
                      showAnswer = false;
                      answeredCount = 0;
                      answeredFlashcards.clear(); // Reset the tracking when restarting
                    });
                  },
